#!/usr/bin/env python3
"""
Check the correct database connection and skill records
"""
...
DATABASE_URL = "mssql+pyodbc://DESKTOP-5TCAPE1/blogDb?driver=ODBC+Driver+17+for+SQL+Server&Trusted_Connection=yes"

def check_database():
    print("CORRECT DATABASE DEBUG CHECK")
    print("=" * 50)
